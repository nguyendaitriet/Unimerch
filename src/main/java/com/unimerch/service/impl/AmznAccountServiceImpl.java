...
//        }
    ...
    public AmznAccResult findByUsername(String username) {
        AmznAccount amznUser = amznAccountRepository.findByUsername(username);
        if (amznUser == null) throw new UserNotFoundException("{exception.userNotFound}");
        return amznAccountMapper.toAmznAccResult(amznUser);
    }
